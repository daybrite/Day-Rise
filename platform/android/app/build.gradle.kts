...
android {
    ...
    namespace = dayApp.getProperty("namespace") ?: "dev.daybrite.dayrise"
    compileSdk = 35
    defaultConfig {
        ...
        manifestPlaceholders["dayTitle"] = dayApp.getProperty("title") ?: "Day Rise"
        manifestPlaceholders["dayScheme"] = dayApp.getProperty("scheme") ?: "dayrise"
